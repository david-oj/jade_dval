...
const Hero = () => {
  return (
    <section className="section-mx section-px relative xl:my-16 md:my-10 my-8 overflow-hidden">
      <div className="md:max-h-[500px] max-h-screen flex gap-8 flex-col md:flex-row">
        <div className="flex-1 flex flex-col max-md:text-center max-md:items-center lg:gap-8 gap-4 ">
          ...
          <div className="flex md:gap-4 gap-2 md:flex-row ">
            <Button className="text-white min-w-[126px] text-base font-semibold py-2 opacity-50"> View Courses</Button>
            <Button className="text-white min-w-[126px] text-base font-semibold py-2 opacity-50">Partner </Button>
          </div>
        </div>
