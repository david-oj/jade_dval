      ...
      <div className="flex flex-col">
        ...
        <div className="flex flex-wrap justify-between max-sm:justify-center gap-4 mt-6 sm:mt-8">
          {courses.map((course, idx) => (
            <div
              key={idx}
              className=" sm:max-w-[290px] group flex flex-col max-w-[250px] min-w-[250px] max-sm:min-w-[200px] flex-1"
            >
              {/* course card image */}
              ...
              <p className="max-w-[290px] flex-grow opacity-80">{course.description}</p>
              <div className=""></div>
              <a href="#" className="flex sm:mt-2 mt-3 justify-center transition-all group-hover:gap-4 gap-2 items-center w-fit">
                <p className=" text-brand group-hover:underline transition-all">{course.linkText}</p>
